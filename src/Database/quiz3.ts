...
export const quiz3: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      negativePoints: 1,
      question:
        "Who is the Youngest Badminton Player to represent Indian at Championship?",
      options: [
        {
          _id: "1",
          isRight: true,
    ...
    },
    {
      ...
      negativePoints: 1,
      question:
        "Who was the first Indian badminton Player to hold number one rank in World Rankings?",
      options: [
        {
          _id: "1",
          isRight: false,
